Namespace Global.Basic.Parser.Dialects
  ...
  ' This dialect is essentially a combination of the following:
  ...
  Friend Class Hybrid
    ...
    Public ReadOnly Property Keywords As System.Collections.Generic.List(Of String) Implements IDialect.Keywords
      Get
        ...
        Return New List(Of String) From {"BEEP",
                                         ...
                                         "END", "ENVIRON", "ERASE", "ERROR",
                                         "FIELD", "FOR", "TO", "STEP", "NEXT",
                                         "GET",
                                         "GOSUB", "GOTO",
                                         "IF", "THEN", "ELSE", "INPUT", "INPUT#", "IOCTL",
                                         "KEY",
                                         "LET", "LINE", "LINE INPUT", "LINE INPUT#", "LOCATE", "LOCK", "LPRINT", "LPRINT USING", "LSET", "RSET",
                                         "ON", "ON COM", "ON KEY", "ON PEN", "ON PLAY", "ON STRIG", "ON TIMER", "ON ERROR GOTO", "OPEN", "OPEN ""COM", "OPTION", "OUT",
                                         "PAINT", "PALETTE", "PALETTE USING", "PEN", "PLAY", "POKE", "PRESET", "PSET", "PRINT", "PRINT USING", "PRINT#", "PRINT# USING", "PUT",
                                         "RANDOMIZE", "READ", "REM", "RESTORE", "RESUME", "RETURN",
                                         "SCREEN", "SHELL", "SOUND", "STOP", "STRIG", "SWAP",
                                         "UNLOCK",
                                         "VIEW", "VIEW PRINT",
    ...
    Public ReadOnly Property Commands As System.Collections.Generic.List(Of String) Implements IDialect.Commands
      Get
        Return New List(Of String) From {"AUTO",
                                         "BLOAD", "BSAVE",
                                         "CHDIR", "CLEAR", "CONT",
                                         "DELETE",
                                         "EDIT",
                                         ...
                                         "NAME", "NEW",
                                         "PCOPY",
                                         "RENUM", "RESET", "RMDIR", "RUN",
                                         "SAVE", "SYSTEM",
                                         "TRON", "TROFF",
                                         "VER", "HELP", "KEYWORDS", "OLD", "PARSER"}
      End Get
    End Property
