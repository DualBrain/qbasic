Namespace Global.QB.CodeAnalysis.Syntax
  ...
  Friend Class PsetStatementSyntax
    Inherits StatementSyntax

    Public Sub New(tree As SyntaxTree,
                   psetKeyword As SyntaxToken,
    ...
    Public Overrides ReadOnly Property Kind As SyntaxKind = SyntaxKind.PSetKeyword
    Public ReadOnly Property PsetKeyword As SyntaxToken
