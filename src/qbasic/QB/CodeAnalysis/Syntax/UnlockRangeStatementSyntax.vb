Namespace Global.QB.CodeAnalysis.Syntax
  ...
  Friend Class UnlockRangeStatementSyntax
    Inherits StatementSyntax

    Public Sub New(tree As SyntaxTree, unlockKeyword As SyntaxToken, pound As SyntaxToken, fileNumber As ExpressionSyntax, comma As SyntaxToken, record As ExpressionSyntax, toKeyword As SyntaxToken, [end] As ExpressionSyntax)
      MyBase.New(tree)
    ...
    Public Overrides ReadOnly Property Kind As SyntaxKind = SyntaxKind.UnlockRangeStatement
