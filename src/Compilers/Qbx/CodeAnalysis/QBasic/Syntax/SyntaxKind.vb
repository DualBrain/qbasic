Namespace Global.Basic.CodeAnalysis.QBasic

  ''' <summary>
  ''' Enumeration with all QBasic syntax node kinds.
  ''' </summary>
  Public Enum SyntaxKind As UShort

    'NOTE: When adding any new syntax, add to the end to maintain binary compatibility.
