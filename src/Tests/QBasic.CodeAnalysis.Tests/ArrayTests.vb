...
result4 = arr2(1)
    ...
    <Fact>
    Public Sub DynamicMetacommand_EnablesRedim()
...
result2 = arr(10)
      ...
      Assert.Equal(0L, CLng(variables("result1")))
      Assert.Equal(100L, CLng(variables("result2")))

    End Sub

    <Fact>
    Public Sub StaticMetacommand_DisablesRedim()
...
REDIM arr(20)
      ...
      Dim expected = "Cannot REDIM static array 'arr'"
    ...
    <Fact>
    Public Sub DynamicMetacommand_PositionalBehavior()
...
result1 = dynamicArr(5)
result2 = staticArr(5)
]]></sample>.Value

      Dim expected = "Cannot REDIM static array 'staticArr'"
    ...
    <Fact>
    Public Sub DynamicMetacommand_StaticMetacommandAfterDeclarations()
...
result = arr(5)
      ...
      Assert.Equal(0L, CLng(variables("result")))

    End Sub

    <Fact>
    Public Sub DynamicMetacommand_MultipleDynamicArrays()
...
result3 = arr3(3)
    ...
    <Fact>
    Public Sub DynamicMetacommand_MixedStaticAndDynamic()
...
result1 = staticArr(1)
result2 = dynamicArr(2)
result3 = staticArr2(3)
]]></sample>.Value
      ...
      Assert.Equal(1L, CLng(variables("result1")))
      Assert.Equal(0L, CLng(variables("result2")))
      Assert.Equal(3L, CLng(variables("result3")))

    End Sub

    <Fact>
    Public Sub DynamicMetacommand_CommentForm()
...
result = arr(5)
    ...
    <Fact>
    Public Sub DynamicMetacommand_WithoutDollarSign()
