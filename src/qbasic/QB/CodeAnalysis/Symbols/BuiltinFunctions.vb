...
Namespace Global.QB.CodeAnalysis.Symbols
  ...
  Friend Module BuiltinFunctions
    ...
    Public ReadOnly Point1 As New FunctionSymbol("point", ImmutableArray.Create(New ParameterSymbol("value", TypeSymbol.Double, 0)), If(OPTION_DOUBLE, TypeSymbol.Double, TypeSymbol.Single))
    Public ReadOnly Point2 As New FunctionSymbol("point", ImmutableArray.Create(New ParameterSymbol("x", TypeSymbol.Integer), New ParameterSymbol("y", TypeSymbol.Integer)), TypeSymbol.Integer)
