Public Class FindDialog
  ...
  Public Sub Render() Implements IContext.Render
    ...
    Box0(Location.Row + 1, Location.Col + 13, Location.Row + 3, Location.Col + 57, 1, OneColor(Foreground, Background))
    HLine(Location.Row + 8, Location.Col, Location.Col + Size.Cols - 1, 1, OneColor(Foreground, Background))
  End Sub
