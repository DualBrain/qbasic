  ...
  Public Class SoundGenerator
    ...
    Private Sub InternalNew(sampleRate As Integer,
      ...
      If False Then
        ...
        Dim buffer = GenerateTone(m_frequency, 1)
    ...
    Private Shared Function GenerateTone(frequency As Single,
      ...
      Else
        For K = startPos To startPos + length
          buffer(K) = CShort(Math.Floor(Math.Sin(K / v1) * (32766.5 * amplitude)))
        Next
      End If
...
#End Region
  ...
  Friend Class Oscillator
    ...
    Public Property Frequency() As Double
      Set(value As Double)
        m_frequency = value
        m_phaseAngleIncrement = CUInt(Math.Floor(m_frequency * UInteger.MaxValue / m_sampleRate))
      End Set
      Get
        Return m_frequency
      End Get
    ...
    Public Function GetNextSample() As Short 'Implements ISampleProvider.GetNextSample
      ...
      Dim wholePhaseAngle As UShort = CUShort(m_phaseAngle >> 16)
      Dim amplitude As Short '= 0
