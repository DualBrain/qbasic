...
Namespace Global.QB.CodeAnalysis.Symbols
  ...
  Friend Module BuiltinFunctions
    ...
    Public ReadOnly Exp As New FunctionSymbol("exp", ImmutableArray.Create(New ParameterSymbol("value", TypeSymbol.Double, 0)), TypeSymbol.Double)
    ...
    Public ReadOnly Fix As New FunctionSymbol("fix", ImmutableArray.Create(New ParameterSymbol("value", TypeSymbol.Double, 0)), TypeSymbol.Double)
